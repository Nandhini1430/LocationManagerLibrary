#
# Be sure to run `pod lib lint LocationManagerLibrary.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'LocationManagerLibrary'
  s.version          = '0.1.0'
  s.summary          = 'A short description of LocationManagerLibrary.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'LocationManagerLibrary' => ['LocationManagerLibrary/Assets/*.png']
  # }
